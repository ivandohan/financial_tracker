...
class AppColor {
  static const Color ftScaffoldColor = Color(0xFF141414);
  static const Color ftBottomNavigatorColor = Color(0xFF000000);
  static const Color ftBottomNavigatorSelectorColor = Color(0xFFB65D12);
  static const Color ftFloatingButton = Color(0xFF00028C);
  ...
  static const Color ftTextLinkColor3 = Color(0xFF159406);
  static const Color ftLoadingSpinKitColor = Color(0xFF959191);
  static const Color ftTextPrimaryColor = Color(0xFFEA4040);
  static const Color ftTextSecondaryColor = Color(0xFFFFFFFF);
  static const Color ftTextTertiaryColor = Color(0xFF9E9E9E);
  static const Color ftTextIncomeColor = Color(0xFF28C216);
  static const Color ftTextIncomeColor2 = Color(0xFFF6AA3D);
