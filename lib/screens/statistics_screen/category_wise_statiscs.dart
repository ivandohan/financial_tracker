  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Grafik Statistik',
          style: TextStyle(fontSize: 17, color: AppColor.ftTextSecondaryColor),
        ),
        actions: [
          IconButton(
              onPressed: () {
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                '${currencySymbolUpdate.value} ${formatter.format(amount)}',
                                                style: const TextStyle(
                                                    color: AppColor
                                                        .ftTextSecondaryColor,
                                                    fontWeight:
                                          ...
                                          children: [
                                            Padding(
                                              padding:
                                                  const EdgeInsets.all(8.0),
                                              child: Text(
                                                "Tanggal : ${DateFormat("MMM dd").format(DateTime.parse(startDate!))} - ${DateFormat("MMM dd").format(DateTime.parse(endDate!))}",
                                                style: const TextStyle(
                                                    color: AppColor
                                                        .ftTextTertiaryColor,
                                                    fontWeight:
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Text(
                                              '${currencySymbolUpdate.value} ${formatter.format(newData[index].amount)}',
                                              style: const TextStyle(
                                                  color: AppColor
                                                      .ftTextTertiaryColor),
                                            ),
