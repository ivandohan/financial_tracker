              ...
              children: [
                IconButton(
                  ...
                  icon: const Icon(Icons.arrow_back_ios,
                      color: AppColor.ftTextSecondaryColor, size: 16),
                  onPressed: () {
                    setState(
                      () {
                ...
                TextButton(
                  style: TextButton.styleFrom(
                      foregroundColor: AppColor.ftScaffoldColor),
                  onPressed: () async {
                    var dateRange =
                ...
                IconButton(
                  ...
                  onPressed: () {
                    setState(
                      () {
                        selectedDate = SelectDate().selectNextMonth();
                      },
                    );
                    TransactionDB.instance.refresh();
                  },
                                        ...
                                        children: [
                                          const Text(
                                            ...
                                            style: TextStyle(
                                              ...
                                              color:
                                              AppColor.ftTextSecondaryColor,
                                              fontSize: 20,
                                            ),
                                          ),
                                          Text(
                                            '${currencySymbolUpdate.value} ${formatter.format(incomeData - expenseData)}',
                                ...
                                children: [
                                  ...
                                  FittedBox(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        '${currencySymbolUpdate.value} ${formatter.format(incomeData)}',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w700,
                                            color: AppColor.ftTextSecondaryColor,
                                            fontSize: MediaQuery.of(context)
                                  ...
                                  FittedBox(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          left: 5, right: 5, top: 2),
                                      child: Text(
                                        '${currencySymbolUpdate.value} ${formatter.format(expenseData)}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.w700,
                                          color: AppColor.ftTextSecondaryColor,
                                          fontSize: MediaQuery.of(context)
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '+ ${currencySymbolUpdate.value} ${formatter.format(incomeDataForDay)}',
                                                      style: const TextStyle(
                                                          color: AppColor
                                                              .ftTextIncomeColor,
                                                          fontSize: 13),
                                                    ...
                                                    Text(
                                                      '- ${currencySymbolUpdate.value} ${formatter.format(expenseDataForDay)}',
                                                      style: const TextStyle(
                                                          color: AppColor
                                                              .ftTextExpenseColor,
                                                          fontSize: 13),
