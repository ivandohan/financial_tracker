...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        appBarTheme: const AppBarTheme(color: AppColor.ftScaffoldColor),
        primaryColor: AppColor.ftScaffoldColor,
        splashFactory: NoSplash.splashFactory,
        splashColor: Colors.transparent,
        highlightColor: Colors.transparent,
        hoverColor: Colors.transparent,
        colorScheme: ColorScheme.fromSeed(seedColor: AppColor.ftScaffoldColor),
        useMaterial3: true,
      ),
